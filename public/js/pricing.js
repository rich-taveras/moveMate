function calculateDistance() {
    const showmapEl = document.getElementById('map');
    const showresults1El = document.getElementById('result1');
    const showresults2El = document.getElementById('result2');
    const showresults3El = document.getElementById('result3');
    ...
    function showMap(){
        showmapEl.classList.add('d-block');
        showresults1El.classList.add('d-block');
        showresults2El.classList.add('d-block');
        showresults3El.classList.add('d-block');
    }
